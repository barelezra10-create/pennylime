...
export async function GET() {
  ...
  out.push(
    `> Personal loans of $100 to $10,000 for gig workers and small businesses. PennyLime verifies gig earnings instead of relying on traditional credit, with funds delivered in 48 hours after approval. Owned and operated by 770 Technology Way LLC, a Florida limited liability company.`
  );
