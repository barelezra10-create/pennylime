...
const TOOL_ICONS: Record<string, React.ReactNode> = {
  "advance-calculator": <svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="5" y="3" width="18" height="22" rx="2" stroke="currentColor" strokeWidth="2" /><path d="M9 8H19M9 12H14M9 16H19M9 20H14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" /></svg>,
  ...
  "advance-comparison": <svg width="28" height="28" viewBox="0 0 28 28" fill="none"><rect x="3" y="10" width="8" height="14" rx="1" stroke="currentColor" strokeWidth="2" /><rect x="17" y="4" width="8" height="20" rx="1" stroke="currentColor" strokeWidth="2" /><path d="M13 14H15" stroke="currentColor" strokeWidth="2" strokeLinecap="round" /></svg>,
  ...
  "advance-affordability-calculator": <svg width="28" height="28" viewBox="0 0 28 28" fill="none"><path d="M14 4L4 9V18C4 22 8 26 14 28C20 26 24 22 24 18V9L14 4Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" /><path d="M10 14L13 17L18 11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>,
};
