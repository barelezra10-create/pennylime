...
export default function FunnelPreviewPage() {
  return (
    <div className="-m-6 lg:-m-8 h-[calc(100vh-120px)]">
      <div className="bg-[#f4f4f5] border-b border-[#e4e4e7] px-4 py-2 flex items-center gap-3 flex-wrap">
        ...
        <a
          href="/apply?preview=1&step=docs&platform=uber"
          target="_blank"
          rel="noopener"
          className="ml-auto text-[12px] font-semibold text-[#15803d] hover:underline"
        >
          Test statements step only ↗
        </a>
        <a
      ...
      <iframe
        src="/apply?preview=1&step=docs&platform=uber"
