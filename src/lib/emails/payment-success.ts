  ...
  return {
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        ${params.remainingBalance <= 0 ? '<p style="color: #15803d; font-weight: bold;">Congratulations! Your loan is fully paid off!</p>' : ""}
        <p>View your loan: <a href="${statusUrl}" style="color: #15803d;">${statusUrl}</a></p>
